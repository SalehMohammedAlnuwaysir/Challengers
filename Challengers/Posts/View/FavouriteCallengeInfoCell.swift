//
//  FavouriteCellInfoCell.swift
//  Challengers
//
//  Created by Saleh on 14/03/1440 AH.
...
class FavouriteCallengeInfoCell: UITableViewCell {
    var Chall:challenge!
    ...
    @IBAction func favBtn(_ sender: Any) {
        if(!favBtnStatus){//Not in the fav
            ...
            //remove from myFaveChallIds arry
            for i in 0...myFaveChallIds.endIndex{
